...
public interface TestEngine {
	...
	default Optional<String> getArtifactId() {
		if (ReflectionUtils.isJavaPlatformModuleSystemAvailable()) {
			return Optional.of(ReflectionUtils.eval(getClass(), "getModule", "getDescriptor", "name").toString());
		}
	...
	default Optional<String> getVersion() {
		...
		if (ReflectionUtils.isJavaPlatformModuleSystemAvailable()) {
			String[] getterChain = { "getModule", "getDescriptor", "rawVersion" };
			return ReflectionUtils.eval(Optional.of(fallback), getClass(), getterChain);
		}
